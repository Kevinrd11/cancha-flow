  ...
  return (
    <footer className="bg-[#0b2119] text-white">
      <div className="mx-auto grid max-w-7xl gap-9 px-4 py-12 sm:px-6 md:grid-cols-[1fr_auto_auto]">
        ...
        <div><p className="text-sm font-bold">Jugar</p><div className="mt-4 grid gap-2 text-sm text-white/55"><Link href="/canchas">Buscar canchas</Link><Link href="/#como-funciona">Cómo reservar</Link></div></div>
